...
select * from produtos where valor between 400.00 and 600.00;

update produtos set QUANTIDADE = QUANTIDADE + 50 where valor between 400.00 and 600.00 ; 

select * from produtos where valor between 400.00 and 600.00;

-- 3. Aplicar um desconto de 50% (*0.5) em todos os produtos que as unidades de estoque sejam maiores que 300 

update produtos set valor = valor * 0.50 where QUANTIDADE between 300 and 900;
...
select * from produtos where nome like 'mo%' or nome like '%ma%'; 
